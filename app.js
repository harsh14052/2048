  ...
  function combineRow() {
    for (let i = 0; i < 15; i++) {
      if (squares[i].innerHTML === squares[i + 1].innerHTML) {
        console.log(squares[i].innerHTML, squares[i + 1].innerHTML);
        if (squares[i].innerHTML === "") squares[i].innerHTML = 0;
        if (squares[i + 1].innerHTML === "") squares[i + 1].innerHTML = 0;
        let combinedTotal =
  ...
  function combineColumn() {
    for (let i = 0; i < 12; i++) {
      if (squares[i].innerHTML === squares[i + width].innerHTML) {
        console.log(squares[i].innerHTML, squares[i + width].innerHTML);
        if (squares[i].innerHTML === "") squares[i].innerHTML = 0;
